# Script to prepare the data for WP4 of the Mediterranean case study.
...
# 5. Write WP4_med object

# The following files are required:
# Europe_coastline_poly.shp
# alp_gsa_sett_2014.shp
# data/med/WP4_results_GSA17-18-19/D4.3/RBS_2017_2021_AdriaticSea_GSAs17_18.tif
# data/med/WP4_results_GSA17-18-19/D4.3/RBS_2017_2021_WesternIonianSea_GSA19.tif
# data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/D4.3/GSA20_RBS.tiff
# data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/D4.5/T4_5_trawlslitter_GSA20.tiff
# data/med/WP4_results_GSA17-18-19/D4.5/Litter_FR_kg_km2_1.tif
# data/med/WP4_results_GSA17-18-19/D4.2/OTB_SQUABLA_risk.shp
# data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/D4.2/T4_2_MPO_LLS_ex_score_GSA20.tiff
...
usethis::use_data(gsa, overwrite = TRUE)
...
rsgsa17 <- raster("./data-raw/wp4/data/med/WP4_results_GSA17-18-19/D4.3/RBS_2017_2021_AdriaticSea_GSAs17_18.tif")


# 2. Prepare RBS data
rbs_gsa17_18 <- as.data.frame(raster("./data-raw/wp4/data/med/WP4_results_GSA17-18-19/D4.3/RBS_2017_2021_AdriaticSea_GSAs17_18.tif"),xy = TRUE)

rbs_gsa19 <- as.data.frame(raster("./data-raw/wp4/data/med/WP4_results_GSA17-18-19/D4.3/RBS_2017_2021_WesternIonianSea_GSA19.tif"),xy = TRUE)

rbs_gsa20 <- as.data.frame(raster("./data-raw/wp4/data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/T4_3/GSA20_RBS.tiff"),xy = TRUE)

rbs_data <- list(rbs_gsa17_18, rbs_gsa19, rbs_gsa20)


# 3. Prepare litter data
litter_gsa17_18 <- as.data.frame(raster("./data-raw/wp4/data/med/WP4_results_GSA17-18-19/D4.5/Litter_FR_kg_km2_1.tif"),xy = TRUE)

overlapprob_gsa20 <- as.data.frame(raster("./data-raw/wp4/data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/T4_5/T4_5_trawlslitter_GSA20.tiff"),xy = TRUE)
...
# 4. Prepare bycatch data
squabla_gsa17_18 <- read_sf("./data-raw/wp4/data/med/WP4_results_GSA17-18-19/D4.2/OTB_SQUABLA_risk.shp",crs=4326)
...
MPO_gsa20 <- as.data.frame(raster("./data-raw/wp4/data/med/figures_rasters_GSA20_v2/figures_rasters_GSA20/T4_2/T4_2_MPO_LLS_ex_score_GSA20.tiff"),xy = TRUE)
...
# 5. Write WP4_med object
WP4_med <- list(rbs = rbs_data,
                bycatch = bycatch,
                litter = litter,
                map_parameters = list(coordslim = coordslim,
                                      coordxmap = coordxmap,
                                      coordymap = coordymap,
                                      gsa_centroids = gsa_centroids))

usethis::use_data(WP4_med, overwrite = T)
